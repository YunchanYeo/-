...
export const config = {
    /** 是否使用mock代替api返回 */
    /**
     * true  = 프론트가 "목(mock) 데이터"를 사용합니다. (초기 개발/화면 작업용)
     * false = 프론트가 "진짜 백엔드(우리 서버)"를 호출합니다.
     *
     * 백엔드/DB를 붙이기 전에는 true로 두는 게 안전합니다.
     * 백엔드가 준비되면 false로 바꿔서 전체 화면이 실데이터 기반으로 동작하게 만드세요.
     */
    useMock: false,
    /**
     * 백엔드 API Base URL
